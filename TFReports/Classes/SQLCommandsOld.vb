...
Public Class SQLCommandsOld
    ...
    '    End Function
    '    Public Function E06_ProfitPerClientWithBudgetComparison(ByVal TagGroup As Integer, ByRef mReport As Reports.ReportsCollection) As SqlCommand
    ...
    '        Return sqlComm
    '    End Function
    '    Public Function E12_ProfitPerOPSGroupWithBudgetComparison(ByVal TagGroup As Integer, ByRef mReport As Reports.ReportsCollection) As SqlCommand
    ...
    '    End Function
    '    Public Function E13_TicketAnalysis(ByVal UninvoicedOnly As Boolean, ByRef mReport As Reports.ReportsCollection) As SqlCommand
    ...
    '      , (SELECT TOP 1 ISNULL(REPLACE(REPLACE(Services.Description,CHAR(13),'|'),CHAR(10),'|'), '')
    '	     FROM TravelForceCosmos.dbo.PNR 
    '		      LEFT JOIN TravelForceCosmos.dbo.Services    
    '			       ON PNR.Id = Services.PNRID
    '			  WHERE PNR.Code = CommercialTransactions.CustomDescription2) AS ServicesDescription
    '        , (SELECT Tags.Description
    '        FROM TFEntityTags
    '        LEFT JOIN Tags
    '        ON TFEntityTags.TagID = Tags.Id
    '        WHERE TFEntities.Id = TFEntityTags.TFEntityID
    '        AND Tags.TagGroupID=149) AS ClientTeam
    ...
    '        sqlComm.CommandText = "ATPIData.dbo.TFReports_E18_AirTicketSales"
    '        Return sqlComm

    '    End Function
    '    Public Function E19_DailyProfitReportInvoicesWithTicketNumber(ByRef mReport As Reports.ReportsCollection) As SqlCommand
